...
public class UserMenus {
	...
	public void OwnerMenu(Object object) {
		...
		case 3:
			...
			break;
		case 4:
			((StorageUnitOwner) object).HireAgents();
			OwnerMenu(object);
			break;
		case 0:
			MainMenu();
	...
	public void AgentMenu(Object object) {
		...
		System.out.println("2. List Free Storage Units");
		System.out.println("3. List Free Storage Units (Period)");
		...
		switch (choice) {
		case 1:
			//((StorageUnitAgent) object).CreateContract(); // НЕ РАБОТИ
			AgentMenu(object);
			break;
		case 2:
			((StorageUnitAgent) object).ListFreeUnits();
			AgentMenu(object);
			break;
		case 3:
			//((StorageUnitAgent) object).();
			AgentMenu(object);
			break;
		case 4:
			((StorageUnitAgent) object).ListTenants();
			AgentMenu(object);
			break;
		case 0:
			MainMenu();
