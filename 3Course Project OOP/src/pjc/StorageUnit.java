...
public class StorageUnit {
	...
	public void SetContractor(StorageUnitAgent object) {
		Contracted_By.add((StorageUnitAgent)object);
	}

	public void PrintUnit() {
		System.out.println("ID: " + unit_id +
				" Storage Unit Owner: " + Owned_By.Get_Last_Name() + " " +
				" Unit Name: " + Name + " Address: " + Address + " Size(m^2): " +
				Size + " Category: " + Category + " Climatic Conditions: " + 
				Climatic_Conditions + " Containings: " + Containings + 
		...
		Query query1 = session1.createQuery("FROM  StorageUnitAgent");
